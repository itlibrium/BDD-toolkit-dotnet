...
{
    public class RechargePrePaidAccountTests : IClassFixture<WebApplicationFactory<Startup>>, IDisposable
    {
        private Context CurrentContext { get; }

        public RechargePrePaidAccountTests(WebApplicationFactory<Startup> appFactory)
        {
            var serviceProvider = appFactory.WithWebHostBuilder(builder => builder
