...
namespace BddToolkit.Examples.Scenarios
{
    public class PrePaidAccountTests
    {
        ...
        private static readonly Feature RechargingPrePaidAccount = Bdd.Feature(
            nameof(RechargingPrePaidAccount), 
        ...
        private static readonly Rule DebtIsAlwaysRepaidInTheFirstPlace = Bdd.Rule(
            RechargingPrePaidAccount, 
            nameof(DebtIsAlwaysRepaidInTheFirstPlace), 
            "Optional description");
        ...
        private class Context
        {
            ...
            public void AmountAvailableWas(decimal value, Currency currency) => _amountAvailable = Money.Of(value, currency);
